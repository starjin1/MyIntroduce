...
function Motivate() {
    return (
        ...
        <ContentBox>
            <BoxContent>
            저는 Python을 활용한 Django 와 JavaScript를 이용한 React와 TypeScript 등의 학교 수업과 개인적인 개발을 진행 하면서 특히 React를 이용하여 웹을 디자인하고 만드는 과정에 흥미를 느끼게 되었고 웹 프론트앤드 쪽을 희망하게 되었습니다. 
            ...
            저는 귀사에 입사하여 React와 TypeScript를 이용하여 회사에 필요한 웹을 개발하는 등 사람들이 후기를 남기고 공유하는 리뷰 문화를 함께 써 내리고싶습니다.
