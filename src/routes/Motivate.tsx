...
function Motivate() {
    return (
        ...
        <ContentBox>
            ...
            스프레이 앱 기능을 수정 및 추가함으로써 사람들에게 앱이 많이 알려질 수 있게 하며 스프레이 앱이 커머스 형태의 유튜브가 되는 길에 함께하고 싶습니다.
            저는 입사하고 난 뒤에도 지속적으로 React와 TypeScript 프로그래밍에 대해 기초적인 부분뿐만 아니라 심화적인 부분까지도 계속 공부하며 저의 기술과 프로그래밍 능력을 발전시키겠습니다. 
